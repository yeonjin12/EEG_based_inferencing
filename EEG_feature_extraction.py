...
def generate_feature_vectors_from_samples_matrix(matrix, nsamples, period, 
										  state = None, 
										  remove_redundant = True,
										  cols_to_ignore = None):
	"""
	Reads data from 2D numpy array "matrix" and extracts statistical features 
	...
	Parameters:
		matrix (numpy.ndarray): 2D numpy array containing the records
